...
To investigate the effects of class size on student achievement in the primary grades, the Tennessee State Department of Education initiated a four-year randomized study known as the Student/Teacher Achievement Ratio (STAR) from 1985 to 1989.
...
The STAR dataset contains information on 11,601 students who participated in the experiment. It includes a variety of data which contains demographic variables, school and class identifiers, details about schools and teachers, experimental conditions (class types), scores from achievement tests (SAT), and scores related to motivation and self-concept.
