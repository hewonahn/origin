...
This report delves into the impact of class size on first-grade student's mean math scores using the Tennessee Student/Teacher Achievement Ratio (STAR) dataset. We aim to explore the purpose and motivation of our analysis in the introduction while examining the dataset's data source, target population, sampling method, and variables in the background. 
We will conduct descriptive analysis, utilizing both univariate and multivariate descriptive statistics, to explore variables relevant to our primary question. Furthermore,  we will employ our statistical methodology (Two-Way Anova) in inferential analysis to address our primary question. We will execute a sensitivity analysis to evaluate the robustness of our model.

In this final report, we extend the initial study made in the inital report by introducing a third question of interest. With the initial questions, we also aim to analyze the factors influencing the average math scores across different schools in an extended analysis. By focusing on the mean math scores of schools, we seek to identify and understand the variables that contribute to variations in academic performance within the educational system. 

We also omitted unnecessary plots and tables from the initial report and included explanations for our findings (Tukey's range test). This approach allows us to focus on the most relevant insights.
...
These findings have the potential to inform educational policies and practices, guiding decision-makers in optimizing classroom environments to enhance students learning. Additionally, we seek to contribute meaningfully to society by helping to suggest effective educational strategies and interventions.
...
In order to explore the impact of class size on academic achievement among students, the Tennessee State Department of Education carried out a four-year randomized study called the Student/Teacher Achievement Ratio (STAR) from 1985 to 1989.
...
2. Regular with a full-time Aide (22-25 students) 
3. Regular (22-25 students)


The academic performance of students was evaluated by using the Stanford Achievement Tests (SATs) developed by the Psychological Corporation in 1983.

A total of 79 schools participated in this experiment, with over 7,000 students involved every year. Each participating school included at least one class of each size, and students were randomly assigned to one of the class types. 

The STAR dataset contains information on 11,601 students who participated in the experiment with decent amount of missing values. It includes a variety of data which contains demographic variables, school and class identifiers, details about schools and teachers, experimental conditions (class types), scores from achievement tests (SAT), and scores related to motivation and self-concept. 
...
From the result of the analysis, We may assume that the reasons for higher mean math scores in smaller class sizes are due to individualized attention, reduced distractions, tailored instruction, and increased student participation.
...
Based on the analysis, it appears that there is a negative linear association between the free lunch ratio, which serves as an indicator for parental income levels, and mean math score. This suggests that students from lower-income backgrounds may face challenges that impact their academic performance in mathematics.

To solve this issue, government-level support for students from economically disadvantaged backgrounds should be made. This could include providing additional resources and support in schools with higher proportions of students receiving free lunch, such as targeted tutoring, mentorship programs, and  access to educational resources.
