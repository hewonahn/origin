...
Similarly, when the school ID is fixed, the mean math score is expected to increase by 11.46 when the class size is small compared to when its regular with aide.
